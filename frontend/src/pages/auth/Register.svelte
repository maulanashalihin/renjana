<script lang="ts">
    ...
    import { Lock, Mail, User, ArrowRight, Eye, EyeOff, Sparkles, UserPlus, Check } from "lucide-svelte";
    ...
    <div class="hidden lg:flex lg:w-1/2 relative items-center justify-center p-12">
        <div class="relative z-10 max-w-lg">
            ...
            <h2 class="text-3xl font-bold text-slate-900 dark:text-white mb-4 leading-tight">
                Bergabung Menjadi Bagian dari<br />
                <span class="text-renjana-500">Relawan Siaga Bencana</span>
            </h2>
            ...
            <div class="bg-white/90 dark:bg-slate-800/50 backdrop-blur-xl rounded-2xl border border-slate-200 dark:border-slate-700/50 p-8 shadow-2xl">
                <div class="text-center mb-6">
                    ...
                    <p class="text-slate-600 dark:text-slate-400 mt-2 text-sm">
                        Mulai perjalanan Anda sebagai relawan RENJANA
                    </p>
                </div>
                ...
                <p class="mt-6 text-center text-sm text-slate-600 dark:text-slate-400">
                    Sudah punya akun?
                    <a href="/login" class="text-renjana-500 hover:text-renjana-600 font-semibold transition-colors">
                        Masuk di sini
                    </a>
                </p>
            </div>
