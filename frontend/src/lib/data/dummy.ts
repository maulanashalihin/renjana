...
export const volunteerDirectory = Array.from({ length: 96 }, (_, i) => {
	...
	return {
		...
		phone: `081${String(20000000 + i * 137)
			.padStart(8, "0")
			.slice(0, 8)}`,
		avatar: `/images/avatar-${(i % 4) + 1}.svg`,
	};
});
