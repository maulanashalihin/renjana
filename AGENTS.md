...
Go Fiber + Svelte 5 + Inertia.js + SQLite (modernc) + templ + NutsDB cache.
...
- **Cache**: `app/cache/` — NutsDB persistent (session + user profile). Auto fallback kalau NutsDB unavailable.
